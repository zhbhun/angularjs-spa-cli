var target = 'http://test-ad-finance.meiyou.com';

module.exports = [
  {
    pattern: new RegExp(target + '/debug'),
    responder: 'http://localhost:8080/static/index.html',
  },
  {
    pattern: new RegExp(target + '/front/(.*)'),
    responder: 'http://localhost:8080/src/$1',
  },
  /*
